...
use factory0_core::{AnyError, ModuleContext};
...
async fn publisher(ctx: &ModuleContext, settings: &Settings, scope: &factory0_core::Scope) {
...
async fn daily(ctx: &ModuleContext, settings: &Settings, scope: &factory0_core::Scope) {
