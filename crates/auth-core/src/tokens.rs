...
//!
//! The decision is recorded in `docs/adr/0101-token-issuing.md`. In
...
//!
//! Signing is hand-framed JWT on `p256` (the ADR 0100 stack), not
...
//!    (reuse detection).
//! 3. **Every timestamp comes from the `Clock` port** (ADR 0100) and
