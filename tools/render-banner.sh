...
K="${BANNER_KICKER:-FACTORY ZER{o} · OPEN SOURCE}"; T="${BANNER_TITLE:-HARNESS}"; S="${BANNER_SUB:-One Rust harness. Every venture compiles its own backend.}"; M="${BANNER_META:-RUST · CLOUDFLARE WORKERS · MODULES AS CRATES · MIT}"; SEED="${BANNER_SEED:-0}"
