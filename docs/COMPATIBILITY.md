...
| `cratefield-chrome` | 0.1.1 | 1 | `^0.3` — `>=0.3.0, <0.4.0` |
...
| `cratefield-dashboard` | 0.1.1 | 1 | `^0.3` — `>=0.3.0, <0.4.0` |
| `cratefield-introspect` | 0.1.1 | 1 | `^0.3` — `>=0.3.0, <0.4.0` |
...
| `sidecar-slow-events` | 0.1.1 | 1 | `^0.3` — `>=0.3.0, <0.4.0` |
